...
// RIDOMOVIE â Embed URL Provider (DHFLIX)
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
//
// PROVIDER_ID:  LRIDOMOVIE
// Display Name: RidoMovies
// Source:       https://ridomovies.tv
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          PROVIDER = 'LRIDOMOVIE';
          DOMAINS = ["https://ridomovies.tv"];
          _di = 0;

          embedUrl = movieInfo.type === 'tv'
            ? DOMAINS[_di] + "/shows/" + movieInfo.tmdb_id + "/" + movieInfo.season + "/" + movieInfo.episode + ""
            : DOMAINS[_di] + "/movies/" + movieInfo.tmdb_id + "";
