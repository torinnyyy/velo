...
// AUTOEMBEDCO â Embed URL Provider (DHFLIX)
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
//
// PROVIDER_ID:  AAutoEmbedCO
// Display Name: AutoEmbed.co
// Source:       https://autoembed.co
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
source.getResource = function (movieInfo, config, callback) {
  return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          PROVIDER = 'AAutoEmbedCO';
          DOMAINS = ["https://autoembed.co"];
          _di = 0;

          embedUrl = movieInfo.type === 'tv'
            ? DOMAINS[_di] + "/tv/tmdb/" + movieInfo.tmdb_id + "-" + movieInfo.season + "-" + movieInfo.episode + ""
            : DOMAINS[_di] + "/movie/tmdb/" + movieInfo.tmdb_id + "";
