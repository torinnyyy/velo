...
// FREMBED â Embed URL Provider (DHFLIX)
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
//
// PROVIDER_ID:  FFrembed
// Display Name: Frembed
// Source:       https://frembed.icu
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          PROVIDER = 'FFrembed';
          DOMAINS = ["https://frembed.icu"];
          _di = 0;

          embedUrl = movieInfo.type === 'tv'
            ? DOMAINS[_di] + "/api/serie.php?id=" + movieInfo.tmdb_id + "&sa=" + movieInfo.season + "&epi=" + movieInfo.episode + ""
            : DOMAINS[_di] + "/api/film.php?id=" + movieInfo.tmdb_id + "";
