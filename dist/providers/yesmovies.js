...
// YESMOVIES â Embed URL Provider (DHFLIX)
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
//
// PROVIDER_ID:  IYesMovies
// Display Name: YesMovies
// Source:       https://ww.yesmovies.ag
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          PROVIDER = 'IYesMovies';
          DOMAINS = ["https://ww.yesmovies.ag"];
          _di = 0;

          embedUrl = movieInfo.type === 'tv'
            ? DOMAINS[_di] + "/movie/" + (movieInfo.imdb_id || ("tt" + movieInfo.tmdb_id)) + "-" + movieInfo.season + "-" + movieInfo.episode + ""
