...
// FMOVIES â Embed URL Provider (DHFLIX)
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
//
// PROVIDER_ID:  KFMOVIES
// Display Name: FlixHQ
// Source:       https://flixhq.to
// ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          PROVIDER = 'KFMOVIES';
          DOMAINS = ["https://flixhq.to"];
          _di = 0;

          embedUrl = movieInfo.type === 'tv'
            ? DOMAINS[_di] + "/embed-tv/" + (movieInfo.imdb_id || ("tt" + movieInfo.tmdb_id)) + "/" + movieInfo.season + "/" + movieInfo.episode + ""
            : DOMAINS[_di] + "/embed-movie/" + (movieInfo.imdb_id || ("tt" + movieInfo.tmdb_id)) + "";
